...
SRC = 0-read_input.c 1-lexer.c 2-lexer_utils.c 3-list_utils.c 4-parsing.c 5-syntax_error.c expansion.c test.c
...
READLINE = /opt/homebrew/Cellar/readline/8.2.13/lib/libreadline.a -lncurses
...
$(NAME) : $(OBJ)
	$(CC)  $(CFLAGS) $(OBJ) $(READLINE) -I$(INC) -o $(NAME)
